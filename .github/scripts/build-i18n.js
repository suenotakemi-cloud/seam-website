...
function build() {
  ...
  const jaUrls = ['/', '/finder', '/skinfinder', '/brand', '/shop', '/onlineshop', '/hairsalon', '/headspa',
    ...
    '/headspa-ginza', '/headspa-nagoya', '/headspa-osaka', '/salon-ginza', '/salon-sapporo', '/salon-osaka', '/salon-nagoya', '/salon-fukuoka', '/aujua-tokyo', '/kerastase-tokyo', '/tokio-tokyo', '/bykarte-tokyo', '/shu-uemura-tokyo', '/lashaddict-tokyo', '/sublimic-tokyo', '/shiseido-professional-tokyo', '/tsururincho-tokyo', '/system-professional-tokyo', '/milbon-tokyo',
    '/recruit',
