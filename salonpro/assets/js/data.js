/* =========================================================
   Salon Town Pro / Data — 商品・カテゴリのマスタ
...
(function () {
  ...
  const products = [
    ...
    /* ===== 契約商品・菊池発注（契約後にSalon Town Proで購入。トキオ=sh-002 は上のシャンプーに既出） ===== */
  ...
  /* =========================================================
     ...
     mode＝発注のしかた：
       ...
       online … 契約商品・菊池発注（オンライン契約→以降は菊池=Salon Town Proで購入）
  ...
  const CONTRACT_BRANDS = [
    ...
    /* --- 契約商品・菊池発注（オンライン契約→以降は菊池=Salon Town Proで購入） --- */
    {
      id: 'baikarute', brand: 'バイカルテ', maker: 'バイカルテ', mode: 'online', fee: 22000, accent: '#4a5b7a',
      tagline: '頭皮から整える、サロン発想のスキャルプケア。',
      lead: '菊地と契約後は、菊地（Salon Town Pro）から通常商品と同じくご発注いただけます。導入研修・運用も菊地がサポートします。',
      points: [
    ...
    },
    {
      ...
      lead: 'コタ アイ ケアなどで知られるブランド。菊地と契約後は、菊地（Salon Town Pro）から通常商品と同じくご発注いただけます。',
      points: [
    ...
    },
    {
      ...
      lead: 'TOKIO IE インカラミで知られるブランド。菊地と契約後は、菊地（Salon Town Pro）から通常商品と同じくご発注いただけます。',
      points: [
    ...
    },
    {
      ...
      lead: '菊地と契約後は、菊地（Salon Town Pro）から通常商品と同じくご発注いただけます。回転率の高いサロンにおすすめです。',
      points: [
  ...
  window.SP.REBATE = {
    enabled: true,
    // 達成特典＝翌月の発注で使える「1本無料の補填チケット」（値引きでなく現品。価格を崩さない）。rewardAmtは目安額。
    tiers: [
      { maker: 'ミルボン', threshold: 200000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 10000 },
      { maker: 'ルベル', threshold: 150000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 8000 },
      { maker: 'ロレアル', threshold: 150000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 8000 },
      { maker: 'アリミノ', threshold: 120000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 6000 },
      { maker: 'ウエラ', threshold: 120000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 6000 },
      { maker: 'シュワルツコフ', threshold: 120000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 6000 },
      { maker: 'ホーユー', threshold: 100000, reward: '翌月限定 1本無料（補填チケット）', rewardAmt: 5000 },
    ],
