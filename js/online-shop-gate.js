...
<div id="seam-gate-card" style="background:#FAF8F4; border:1px solid #E2DDD3; border-radius:3px; max-width:380px; width:100%; padding:38px 28px 26px; text-align:center; box-shadow:0 24px 60px rgba(26,24,21,0.22); position:relative; transform:translateY(8px); transition:transform 260ms ease;">\
  ...
  <a id="seam-gate-find-store" href="haircareshop.html#stores" style="display:flex; align-items:center; justify-content:center; gap:10px; background:#3D3833; color:#FAF8F4; padding:14px 16px; font-family:Inter,\'Noto Sans JP\',sans-serif; letter-spacing:0.26em; text-transform:uppercase; font-size:10.5px; text-decoration:none; border-radius:2px; margin-bottom:8px; transition:background 180ms;">店舗を探す <span aria-hidden="true" style="color:#D9BE93;">→</span></a>\
