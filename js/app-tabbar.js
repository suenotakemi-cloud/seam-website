...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      '#seam-tabbar .seam-tab span{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;letter-spacing:.04em;font-family:メイリオ,"Hiragino Sans","Noto Sans JP",sans-serif;line-height:1.15;}',
      ...
      '#seam-tab-sheet .seam-sheet-pill{margin-left:auto;flex:0 0 auto;font-family:Inter,"Noto Sans JP",sans-serif;font-size:8px;letter-spacing:.16em;text-transform:uppercase;color:#6e625c;border:0;border-bottom:1px solid #8e817a;border-radius:0;padding:3px 0;}',
      ...
      'background:#faf8f6;border:0;border-right:1px solid #e0d8d2;border-bottom:1px solid #e0d8d2;color:#3D3833;text-decoration:none;font-family:メイリオ,"Hiragino Sans","Noto Sans JP",sans-serif;font-size:11px;letter-spacing:.08em;transition:background .15s;-webkit-tap-highlight-color:transparent;}',
