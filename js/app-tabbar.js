...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      '#seam-tabbar{position:fixed;left:0;right:0;bottom:0;z-index:70;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));',
      'background:rgba(255,255,255,.965);-webkit-backdrop-filter:blur(18px);backdrop-filter:blur(18px);',
      'border-top:1px solid #cfc6c0;padding-bottom:env(safe-area-inset-bottom);box-shadow:none;}',
      '#seam-tabbar .seam-tab{position:relative;min-width:0;min-height:58px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;',
      'padding:7px 1px 6px;border-right:1px solid rgba(207,198,192,.54);text-decoration:none;color:#6f6661;transition:color .2s,background .2s;-webkit-tap-highlight-color:transparent;cursor:pointer;}',
      '#seam-tabbar .seam-tab:last-child{border-right:0;}',
      '#seam-tabbar .seam-tab:before{content:"";position:absolute;left:50%;top:-1px;width:0;height:1px;background:#171413;transform:translateX(-50%);transition:width .22s ease;}',
      '#seam-tabbar .seam-tab svg{width:18px;height:18px;opacity:.78;stroke-width:1.35;}',
      '#seam-tabbar .seam-tab span{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11.5px;letter-spacing:.04em;font-family:メイリオ,"Hiragino Sans","Noto Sans JP",sans-serif;line-height:1.15;}',
      '#seam-tabbar .seam-tab.is-active{color:#171413;background:#faf8f6;}',
      '#seam-tabbar .seam-tab.is-active:before{width:28px;}',
      ...
      '#seam-tab-sheet .seam-sheet-card{pointer-events:auto;background:#fff;border:1px solid #cfc6c0;border-radius:0;',
      'box-shadow:0 20px 46px rgba(26,24,21,.14);padding:0;margin-bottom:10px;min-width:260px;}',
      '#seam-tab-sheet .seam-sheet-item{display:flex;align-items:center;gap:13px;padding:15px 17px;border-radius:0;',
      'color:#211c1a;text-decoration:none;font-family:メイリオ,"Hiragino Sans","Noto Sans JP",sans-serif;font-size:13px;letter-spacing:.03em;transition:background .15s;-webkit-tap-highlight-color:transparent;}',
      ...
      '#seam-tab-sheet .seam-sheet-ic{width:30px;height:30px;border-radius:0;background:transparent;color:#211c1a;display:flex;align-items:center;justify-content:center;flex:0 0 auto;}',
      '#seam-tab-sheet .seam-sheet-ic svg{width:16px;height:16px;}',
      /* ── ショップシート(オンライン+店舗) ── */
      '#seam-tab-sheet .seam-sheet-online{width:100%;border:0;background:none;text-align:left;cursor:pointer;font:inherit;}',
      '#seam-tab-sheet .seam-sheet-online .seam-sheet-ic{background:transparent;color:#211c1a;}',
      '#seam-tab-sheet .seam-sheet-pill{margin-left:auto;flex:0 0 auto;font-family:Inter,"Noto Sans JP",sans-serif;font-size:11.5px;letter-spacing:.16em;text-transform:uppercase;color:#6e625c;border:0;border-bottom:1px solid #8e817a;border-radius:0;padding:3px 0;}',
      '#seam-tab-sheet .seam-sheet-chev{flex:0 0 auto;color:#211c1a;font-size:17px;line-height:1;margin-left:4px;}',
      '#seam-tab-sheet .seam-sheet-divider{height:1px;background:#ddd4ce;margin:0;}',
      '#seam-tab-sheet .seam-sheet-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:0;padding:0;}',
      '#seam-tab-sheet .seam-sheet-store{display:flex;align-items:center;justify-content:flex-start;min-height:48px;padding:11px 15px;border-radius:0;',
      'background:#faf8f6;border:0;border-right:1px solid #e0d8d2;border-bottom:1px solid #e0d8d2;color:#3D3833;text-decoration:none;font-family:メイリオ,"Hiragino Sans","Noto Sans JP",sans-serif;font-size:11.5px;letter-spacing:.08em;transition:background .15s;-webkit-tap-highlight-color:transparent;}',
      ...
      '#seam-tab-sheet .seam-confirm-eyebrow{margin:0 0 8px;font-family:Inter,"Noto Sans JP",sans-serif;font-size:11.5px;letter-spacing:.3em;text-transform:uppercase;color:#B8945A;}',
      ...
      'font-family:Inter,"Noto Sans JP",sans-serif;font-size:11.5px;letter-spacing:.22em;text-transform:uppercase;padding:10px;}',
      ...
      'font-size:11.5px;letter-spacing:.16em;text-transform:uppercase;line-height:1;transition:border-color .2s,color .2s;-webkit-tap-highlight-color:transparent;min-height:34px !important;min-width:0 !important;}',
      ...
      '#seam-header-shop .shs-short{display:block;font-family:Inter,"Noto Sans JP",sans-serif;font-size:10px;letter-spacing:.1em;line-height:1;margin-top:1.5px;}',
