...
ROLES = {
    "stylist": {
        ...
        "seo_title": "{city}の美容師・スタイリスト求人｜月給30万円〜 歩合50%｜SEAM{city}",
    ...
    "spanist": {
        ...
        "seo_title": "{city}のスパニスト求人（ヘッドスパ専門職）｜月給30万円〜｜SEAM{city}",
    ...
    "shopmanager": {
        ...
        "salary_html": "月給25万円〜 ／ 実績に応じて賞与<br><span style=\"color:#9c8a6a;font-size:12.5px;\">試用期間6ヶ月（期間中も給与は変わりません）</span>",
        "desc_lead": "サロンの入口にあるビューティーショップの運営をお任せします 接客と売場づくりだけでなく 今後は商品開発や広報にも関わっていける仕事です",
        "jp_title": "ショップ管理者（{city}・正社員）",
        "jp_desc": "サロン専売ヘアケア197ブランドのビューティーショップ運営。SEAM {city}。月給25万円〜・実績に応じて賞与。完全週休2日・社会保険完備。試用期間6ヶ月(期間中も給与は同額)。土日に勤務できる方。今後 商品開発や広報にも関わっていきたい方を歓迎します。",
