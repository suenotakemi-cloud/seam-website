...
ROLES = {
    "stylist": {
        ...
        "jp_desc": "フロントショップ型サロンSEAM {city}のスタイリスト。月給30万円〜 指名売上70万円以上で完全歩合(バック率50%・例:売上70万円で月給35万円)。完全週休2日・産休育休は取得実績あり復帰率100%・社会保険完備・NY/ハワイ研修。試用期間2ヶ月(期間中も給与は同額)。まずは見学だけの応募も歓迎。",
    ...
    "spanist": {
        ...
        "jp_desc": "完全個室ヘッドスパのスパニスト。月給30万円〜・指名歩合あり。完全週休2日・産休育休は取得実績あり復帰率100%・社会保険完備。美容師免許必須。カットやカラーは行わないヘッドスパ専門職。試用期間2ヶ月(期間中も給与は同額)。まずは見学だけの応募も歓迎。",
