...
const ROLE = {
  stylist: {
    en: ['Hair Stylist Jobs in {A} | ¥300,000+/mo, 50% Commission | SEAM',
    ...
    ko: ['{A} 미용사·스타일리스트 채용｜월급 30만엔~ 인센티브 50%｜SEAM',
  ...
  assistant: {
    en: ['Hair Salon Assistant Jobs in {A} | ¥250,000+/mo | SEAM',
  ...
  spanist: {
    ...
    ko: ['{A} 스파니스트 채용(헤드스파 전문직)｜월급 30만엔~｜SEAM',
